...
/*   Updated: 2025/02/28 15:00:30 by bamssaye         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_object	*sphere_ob(t_vec3d point, t_color color, double dia, char *path)
{
	...
	obj->color = color;
	obj->center = point;
	obje->bum_tex.bump.img = NULL;
	obje->bum_tex.img.img = NULL;
	obje->type = SPHERE;
	obje->object = obj;
	return (obje);
}
...
t_object	*plane_ob(t_point_normal *p_n, t_color color, char *path)
{
	...
	obje->type = PLANE;
	ft_memset(&obje->bum_tex, 0, sizeof(t_bump));
	obje->bum_tex.bump.img = NULL;
	obje->bum_tex.img.img = NULL;
	obje->object = obj;
	return (obje);
