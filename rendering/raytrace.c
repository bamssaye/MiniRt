...
/*   Updated: 2025/01/27 19:18:54 by bamssaye         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void trace_ray(t_list *obj, t_in_pa *pa, int *stuck, double mx_dist) //trace ray to light source
{
    t_list *lst;
    t_object *objt;
...
void	trace_light_at_intersection(t_minirt *prog, t_in_pa *param)//trace_light_at_intersection
{
	t_obslight	l_param;
	t_npc		inters;
	t_slight	light;
